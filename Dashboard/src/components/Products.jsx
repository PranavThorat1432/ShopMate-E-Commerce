      ...
      <main className="p-2.5 pl-2.5 md:pl-68 w-full">
        ...
        <div className="flex-1 md:p-6">
          ...
          <p className="text-sm text-gray-600 mb-6">
            Manage All Your Websites Users
          </p>
        </div>
        ...
        <div className="p-4 sm:p-8 bg-gray-50 min-h-screen">
          <div
            className={`overflow-x-auto rounded-lg ${loading ? "p-10 shadow-none" : `${products && products?.length > 0 && "shadow-lg"}`}`}
          >
            {loading ? (
                ...
                <tbody>
                  {products.map((p) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 text-yellow-500">{p.ratings}</td>
          ...
          {!loading && products && products?.length > 0 && (
            <div className="flex justify-center items-center gap-2 mt-6">
              <button
                ...
                disabled={page === 1}
                className={`px-3 py-1 rounded ${page === 1 ? "bg-gray-200 text-gray-400 cursor-not-allowed" : "bg-blue-500 text-white hover:bg-blue-600"} cursor-pointer`}
              >
                Previous
              </button>
              ...
              <button
                ...
                className={`px-3 py-1 rounded ${page === maxPage ? "bg-gray-200 text-gray-400 cursor-not-allowed" : "bg-blue-500 text-white hover:bg-blue-600"} cursor-pointer`}
              >
                Next
              </button>
            </div>
        ...
        <button
          ...
          className="fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-full shadow-lg z-50 transition-all duration-300 ease-in-out cursor-pointer"
