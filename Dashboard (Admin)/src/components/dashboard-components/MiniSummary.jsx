...
const MiniSummary = () => {
  ...
  const summary = [
    {
      ...
      subText: `This month sales: ₹${currentMonthSales * 90}`,
    ...
    },
    {
      ...
      subText: topSellingProducts && topSellingProducts.length > 0 
    ...
    },
    {
      ...
      subText: `${lowStockProducts} products running low in stock`,
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-md">
      ...
      <p className="text-sm text-gray-500 mb-4">Summary of key metric for the current month</p>
