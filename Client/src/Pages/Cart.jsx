    ...
    return (
      <div className='min-h-screen pt-20 flex items-center justify-center'>
        <div className='text-center glass-panel max-w-md'>
          ...
          <p className='text-muted-foreground mb-8'>Looks like you haven't added anything to your cart.</p>
                  ...
                  >
                    <div className='flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-6'>
                      ...
                      <div className='flex items-center space-x-4 '>
                        ...
                        <button className='p-2 glass-card hover:glow-on-hover animate-smooth cursor-pointer text-destructive'>
                          <Trash2 className='w-4 h-4' onClick={() => dispatch(removeFromCart(item.product.id))}/>
                        </button>
                      </div>
          ...
          <div className='lg:col-span-1'>
            <div className='glass-panel sticky top-24'>
              ...
              <div className='flex gap-2'>
                {
                  authUser && (
                    <Link to={'/payment'} className='w-full block text-center p-2 gradient-primary text-primary-foreground rounded-lg hover:glow-on-hover animate-smooth font-semibold mb-4'>
                        Proceed to Checkout
                    </Link>
                  )
                }

                <Link to={'/products'} className='w-full block text-center p-2 bg-secondary border-border text-foreground rounded-lg hover:glow-on-hover animate-smooth font-semibold mb-4 hover:bg-accent'>
                  Continue Shopping
                </Link>
              </div>
            </div>
