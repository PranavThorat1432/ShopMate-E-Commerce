...
const AISearchModal = () => {
  ...
  const exampleText = [
    ...
    'Find all leather jackets for man',
      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            <div
              className="w-10 h-10 bg-linear-to-br from-purple-500 to-blue-500 rounded-full flex items-center justify-center"
            >
        ...
        <form onSubmit={handleSearch} className="space-y-6">
          ...
          <button
            ...
            className={`w-full py-4 bg-linear-to-r from-purple-500 to-blue-500 text-white rounded-lg font-semibold hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 ${
