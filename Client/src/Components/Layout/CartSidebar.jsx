    ...
    <>
      ...
      <div className="fixed right-0 top-0 w-96 h-full z-50 glass-panel animate-slide-in-right overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-[hsla(var(--glass-border))]">
          ...
          <button onClick={() => dispatch(toggleCart())} className="p-2 rounded-lg glass-card hover:glow-on-hover cursor-pointer animate-smooth">
        ...
        <div className="p-6">
          {
            cart && cart.length === 0 ? (
              <div className="text-center py-12">
                ...
                <Link to={'/products'} onClick={() => dispatch(toggleCart())} className="inline-block mt-4 px-6 py-2 gradient-primary-foreground rounded-lg hover:glow-on-hover animate-smooth">
                  Browse Products
                </Link>
              </div>
            ) : (
              <>
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center space-x-2 mt-2">
                              ...
                              <button 
                                className="p-1 rounded glass-card hover:glow-on-hover animate-smooth ml-2 text-destructive cursor-pointer" 
                                onClick={() => {
                ...
                <div className="border-t border-[hsla(var(--glass-border))] pt-4 ">
                  ...
                  <Link to={'/cart'} onClick={() => dispatch(toggleCart())} className="w-full py-3 rounded-lg block text-center gradient-primary text-primary-foreground hover:glow-on-hover animate-smooth font-semibold">
                    View Cart & Checkout
                  </Link>
                </div>
              </>
