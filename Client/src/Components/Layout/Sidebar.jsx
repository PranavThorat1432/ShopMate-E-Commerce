    ...
    <>
      ...
      <div className="fixed left-0 top-0 h-full w-80 z-50 glass-panel animate-slide-in-left">
        <div className="flex items-center justify-between p-6 border-b border-[hsla(var(--glass-border))]">
          ...
          <button onClick={() => dispatch(toggleSidebar())} className="p-2 rounded-lg glass-card hover:glow-on-hover cursor-pointer animate-smooth">
                ...
                return (
                  <li key={item.name}>
                    <Link 
                      ...
                      className="flex items-center space-x-3 p-3 rounded-lg glass-card hover:glow-on-hover cursor-pointer animate-smooth text-foreground hover:text-primary group"
                    >
