      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative z-10 glass-panel w-full max-w-md mx-4 animate-fade-in-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Forgot Password Toggle Button */}
            {
              mode === 'signin' && (
                <div className="text-right text-sm">
                  <button type="button" onClick={() => setMode('forgot')} className="text-primary hover:text-accent animete-smooth cursor-pointer">
                    Forgot Password?
                  </button>
                </div>
              )
            ...
            {/* Submit Button */}
            <button type="submit" disabled={isLoading} className={`w-full py-3 gradient-primary flex justify-center items-center gap-2 text-primary-foreground rounded-lg font-semibold animate-smooth ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:glow-on-hover'} cursor-pointer`}>
              {isLoading ? (
                <>
          ...
          {['signin', 'signup'].includes(mode) && (
            <div className="mt-6 text-center">
              <button type="button" onClick={() => {setMode(prev => prev === 'signup' ? 'signin' : 'signup')}} className="text-primary hover:text-accent animate-smooth cursor-pointer">
                {
