...
import { toggleOrderStep } from "../Redux/orderSlice";
...
const PaymentForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (paymentIntent && paymentIntent.status === 'succeeded') {
      ...
      // Clear cart and reset step only after a confirmed successful payment
      dispatch(clearCart());
    ...
    // Any other status – stop spinner and show a generic message
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="glass-panel">
      ...
      <button
        ...
        className="flex justify-center items-center gap-2 w-full py-3 gradient-primary text-primary-foreground rounded-lg hover:glow-on-hover animate-smooth font-semibold cursor-pointer"
      >
        {isProcessing ? (
          <>
            <div
