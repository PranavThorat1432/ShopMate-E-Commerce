...
// Stripe webhook must receive the raw body and be registered
// BEFORE any JSON/urlencoded body parsers.
app.post('/api/payment/webhook', express.raw({ type: 'application/json' }), async (req, res) => {
    ...
    if (event.type === 'payment_intent.succeeded') {
        ...
        try {
            ...
            return res
                .status(500)
                .send('Error updating payment status: ' + (error.message || error));
        }
    }
